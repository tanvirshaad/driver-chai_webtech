...
require '../Controller/getCustomernotification.php';
...
<body>
            ...
            <div class="section">
            <h1>Total Gigs: <?php  echo count($acceptedJobs); ?></h1>
            <?php
                echo '<div class="gigs-section">';
                foreach($acceptedJobs as $gigs)
                {
                    echo '<div class = "item">';
                    ...
                    echo "<div>" . "<form action='../Controller/getCustomernotification.php' method='POST' ><input type='hidden' name='g_id' value='" .$gigs['g_id'] . "'> <input type='submit' class='btn' name='confirm' value='Hire'>" . "</form></div>";
                    echo "</div>";
                }
                echo '</div>';
            ?>
